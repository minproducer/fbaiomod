...
var m = e.forwardRef((function (i, u) {
    var a = i.height,
        c = i.offsetY,
        l = i.offsetX,
        s = i.children,
    ...
    return void 0 !== c && (p = {
        ...
        transform: "translateY(".concat(c, "px)")
    }, m ? "marginRight" : "marginLeft", -l), "position", "absolute"), "left", 0), "right", 0), "top", 0))), e.createElement("div", {
        style: p
    }, e.createElement(h, {
        onResize: function (e) {
            e.offsetHeight && v && v()
        ...
        style: w,
        className: o(n({}, "".concat(f, "-holder-inner"), f)),
        ref: u
    }, d), s, g)))
}));
...
function p(t, n, r) {
    ...
    return e.useEffect((function () {
        var e = function (e, t, n) {
            ...
            for (var l = null, s = 1 !== Math.abs(i - u), f = 0; f < o.length; f += 1) {
                var v = c(r[f]);
                if (v !== c(o[f])) {
                    l = f, s = s || v !== c(o[f + 1]);
                    break
...
const R = function (t, n, r, o) {
    ...
    return a.current.top = t, a.current.bottom = n, a.current.left = r, a.current.right = o,
        function (e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                r = e ? t < 0 && a.current.left || t > 0 && a.current.right : t < 0 && a.current.top || t > 0 && a.current.bottom;
            return n && r ? (clearTimeout(u.current), i.current = !1) : r && !i.current || (clearTimeout(u.current), i.current = !0, u.current = setTimeout((function () {
                i.current = !1
            }), 50)), !i.current && r
        }
};

function M(t, n, r, o, i, u, c) {
    var l = e.useRef(0),
        s = e.useRef(null),
        f = e.useRef(null),
        v = e.useRef(!1),
    ...
    return [function (e) {
        if (t) {
            a.cancel(m.current), m.current = a((function () {
                h.current = null
            }), 2);
            var n = e.deltaX,
                r = e.deltaY,
                ...
                i = n,
                g = r;
            ("sx" === h.current || !h.current && o && r && !n) && (i = r, g = 0, h.current = "sx");
            var p = Math.abs(i),
                R = Math.abs(g);
            null === h.current && (h.current = u && p > R ? "x" : "y"), "y" === h.current ? function (e, t) {
                if (a.cancel(s.current), !d(!1, t)) {
                    var n = e;
                    n._virtualHandled || (n._virtualHandled = !0, l.current += t, f.current = t, w || n.preventDefault(), s.current = a((function () {
                        var e = v.current ? 10 : 1;
                        c(l.current * e, !1), l.current = 0
                    })))
                }
            }(e, g) : function (e, t) {
                c(t, !0), w || e.preventDefault()
            }(e, i)
        }
    }, function (e) {
        t && (v.current = e.detail === f.current)
    }]
}
var E = function () {
    function e() {
        l(this, e), n(this, "maps", void 0), n(this, "id", 0), n(this, "diffRecords", new Map), this.maps = Object.create(null)
    }
    return c(e, [{
        key: "set",
        value: function (e, t) {
...
var L = e.forwardRef((function (r, u) {
    var c = r.prefixCls,
        l = r.rtl,
        s = r.scrollOffset,
        f = r.scrollRange,
        ...
        j = e.useRef(),
        O = function () {
            !0 !== M && !1 !== M && (clearTimeout(j.current), A(!0), j.current = setTimeout((function () {
                A(!1)
            }), 3e3))
        },
        K = f - p || 0,
    ...
    var q = function (e) {
        y(!0), z(x(e, m)), Y(F.current.top), v(), e.stopPropagation(), e.preventDefault()
    };
    e.useEffect((function () {
        ...
        return t.addEventListener("touchstart", e, {
            ...
            function () {
                t.removeEventListener("touchstart", e), n.removeEventListener("touchstart", q)
            }
    }), []);
    var Z = e.useRef();
    Z.current = K;
    var G = e.useRef();
    G.current = V, e.useEffect((function () {
        if (b) {
            var e, t = function (t) {
                    var n = F.current,
                        r = n.dragging,
                        ...
                        i = n.startTop;
                    a.cancel(e);
                    var u = B.current.getBoundingClientRect(),
                        c = p / (m ? u.width : u.height);
                    if (r) {
                        var l = (x(t, m) - o) * c,
                            s = i;
                        !C && m ? s -= l : s += l;
                        var f = Z.current,
                            ...
                            d = v ? s / v : 0,
                            g = Math.ceil(d * f);
                        g = Math.max(g, 0), g = Math.min(g, f), e = a((function () {
                            h(g, m)
                        }))
                    }
                },
            ...
            return window.addEventListener("mousemove", t, {
                ...
                function () {
                    window.removeEventListener("mousemove", t), window.removeEventListener("touchmove", t), window.removeEventListener("mouseup", n), window.removeEventListener("touchend", n), a.cancel(e)
                }
        }
    ...
    }), [s]), e.useImperativeHandle(u, (function () {
        return {
            delayHidden: O
        }
    }));
    var J = "".concat(c, "-scrollbar"),
        Q = {
            position: "absolute",
    ...
    return m ? (Q.height = 8, Q.left = 0, Q.right = 0, Q.bottom = 0, U.height = "100%", U.width = g, C ? U.left = W : U.right = W) : (Q.width = 8, Q.top = 0, Q.bottom = 0, C ? Q.right = 0 : Q.left = 0, U.width = "100%", U.height = g, U.top = W), e.createElement("div", {
        ref: B,
        className: o(J, n(n(n({}, "".concat(J, "-horizontal"), m), "".concat(J, "-vertical"), !m), "".concat(J, "-visible"), _)),
        style: t(t({}, Q), w),
        ...
        ref: I,
        className: o("".concat(J, "-thumb"), n({}, "".concat(J, "-thumb-moving"), b)),
        style: t(t({}, U), R),
        onMouseDown: q
    }))
}));
...
var T = ["prefixCls", "className", "height", "itemHeight", "fullHeight", "style", "data", "children", "itemKey", "virtual", "direction", "scrollWidth", "component", "onScroll", "onVirtualScroll", "onVisibleChange", "innerProps", "extraRender", "styles", "showScrollBar"],
    z = [],
    D = {
        overflowY: "auto",
        overflowAnchor: "none"
...
function k(c, l) {
    var w = c.prefixCls,
        ...
        te = e.useCallback((function (e) {
            return "function" == typeof A ? A(e) : null == e ? void 0 : e[A]
        }), [A]),
        ne = function (t) {
            var n = e.useState(0),
                r = i(n, 2),
            ...
            function f() {
                ...
                var t = function () {
                    var e = !1;
                    a.current.forEach((function (t, n) {
                        if (t && t.offsetParent) {
                            var r = t.offsetHeight,
                                ...
                                u = o.marginBottom,
                                a = r + S(i) + S(u);
                            c.current.get(n) !== a && (c.current.set(n, a), e = !0)
                        }
                    })), e && u((function (e) {
                        return e + 1
                    }))
            ...
            return e.useEffect((function () {
                ...
                var r = t(e);
                a.current.get(r), n ? (a.current.set(r, n), f()) : a.current.delete(r)
            }, f, c.current, o]
        }(te),
        re = i(ne, 4),
        oe = re[0],
        ...
        le = e.useMemo((function () {
            return Object.values(ue.maps).reduce((function (e, t) {
                return e + t
            }), 0)
        }), [ue.id, ue.maps]),
        se = ce && X && (Math.max(C * X.length, le) > Y || !!K),
        fe = "rtl" === O,
        ve = o(k, n({}, "".concat(k, "-rtl"), fe), N),
        de = X || z,
        he = e.useRef(),
        me = e.useRef(),
        ge = e.useRef(),
    ...
    function Ne(e) {
        Me((function (t) {
            var n = function (e) {
                var t = e;
                Number.isNaN(Qe.current) || (t = Math.min(t, Qe.current));
                return t = Math.max(t, 0), t
            }("function" == typeof e ? e(t) : e);
            return he.current.scrollTop = n, n
        }))
    }
    var Ye = e.useRef({
            start: 0,
    ...
    var Pe = e.useMemo((function () {
            ...
            var e;
            if (!se) return {
                scrollHeight: (null === (e = me.current) || void 0 === e ? void 0 : e.offsetHeight) || 0,
                start: 0,
                end: de.length - 1,
                offset: void 0
            };
            for (var t, n, r, o = 0, i = de.length, u = 0; u < i; u += 1) {
                var a = de[u],
                    c = te(a),
                    l = ue.get(c),
                    s = o + (void 0 === l ? C : l);
                s >= Re && void 0 === t && (t = u, n = o), s > Re + Y && void 0 === r && (r = u), o = s
            }
            return void 0 === t && (t = 0, n = 0, r = Math.ceil(Y / C)), void 0 === r && (r = de.length - 1), {
                scrollHeight: o,
                start: t,
                end: r = Math.min(r + 1, de.length - 1),
                offset: n
            }
        }), [se, ce, Re, de, ae, Y]),
        Xe = Pe.scrollHeight,
        ...
        Ae = Pe.end,
        je = Pe.offset;
    Ye.current.start = _e, Ye.current.end = Ae, e.useLayoutEffect((function () {
        var e = ue.getRecord();
        if (1 === e.size) {
            var t = Array.from(e.keys())[0],
                n = e.get(t),
                r = de[_e];
            if (r && void 0 === n)
                if (te(r) === t) {
    ...
    var Ue = Re <= 0,
        ...
        it = v((function (e) {
            if (q) {
                var n = t(t({}, rt()), e);
                ot.current.x === n.x && ot.current.y === n.y || (q(n), ot.current = n)
            }
        }));

    function ut(e, t) {
        var n = e;
        t ? (d.flushSync((function () {
            ye(n)
        })), it()) : Ne(n)
    }
    var at = function (e) {
        ...
        var o, i = e.useRef(!1),
            ...
            f = function (e) {
                if (i.current) {
                    ...
                    s ? u.current = t : a.current = n;
                    var f = r(s, s ? o : c, !1, e);
                    f && e.preventDefault(), clearInterval(l.current), f && (l.current = setInterval((function () {
                        s ? o *= b : c *= b;
                        var e = Math.floor(s ? o : c);
                        (!r(s, e, !0) || Math.abs(e) <= .1) && clearInterval(l.current)
                    }), 16))
                }
            },
            v = function () {
            ...
            d = function (e) {
                o(), 1 !== e.touches.length || i.current || (i.current = !0, u.current = Math.ceil(e.touches[0].pageX), a.current = Math.ceil(e.touches[0].pageY), c.current = e.target, c.current.addEventListener("touchmove", f, {
                    passive: !1
                }), c.current.addEventListener("touchend", v, {
                    passive: !0
                }))
            };
        o = function () {
            c.current && (c.current.removeEventListener("touchmove", f), c.current.removeEventListener("touchend", v))
        }, s((function () {
            return t && n.current.addEventListener("touchstart", d, {
                    passive: !0
                }),
                function () {
                    var e;
                    null === (e = n.current) || void 0 === e || e.removeEventListener("touchstart", d), o(), clearInterval(l.current)
                }
        }), [t])
    }(ce, he, (function (e, t, n, r) {
        var o = r;
        return !nt(e, t, n) && ((!o || !o._virtualHandled) && (o && (o._virtualHandled = !0), ft({
    ...
    function (t, n, r) {
                ...
                var o, i, u = !1,
                    ...
                    s = function (e) {
                        if (!e.target.draggable && 0 === e.button) {
                            var t = e;
                            t._virtualHandled || (t._virtualHandled = !0, u = !0)
                        }
                    },
                    f = function () {
                        u = !1, c()
                    ...
                    v = function (t) {
                        if (u) {
                            var n = x(t, !1),
                                ...
                                o = r.top,
                                a = r.bottom;
                            n <= o ? (i = -y(o - n), l()) : n >= a ? (i = y(n - a), l()) : c()
                        }
                    };
                return e.addEventListener("mousedown", s), e.ownerDocument.addEventListener("mouseup", f), e.ownerDocument.addEventListener("mousemove", v),
                    function () {
                        e.removeEventListener("mousedown", s), e.ownerDocument.removeEventListener("mouseup", f), e.ownerDocument.removeEventListener("mousemove", v), c()
                    }
            }
        }), [t])
    }(se, he, (function (e) {
        ...
        function e(e) {
            var t = Ue && e.detail < 0,
                n = $e && e.detail > 0;
            !ce || t || n || e.preventDefault()
        }
        var t = he.current;
        return t.addEventListener("wheel", ft, {
                passive: !1
            }), t.addEventListener("DOMMouseScroll", vt, {
                passive: !0
            }), t.addEventListener("MozMousePixelScroll", e, {
                passive: !1
            }),
            function () {
                t.removeEventListener("wheel", ft), t.removeEventListener("DOMMouseScroll", vt), t.removeEventListener("MozMousePixelScroll", e)
            }
    }), [ce, Ue, $e]), s((function () {
        if (K) {
            var e = at(be);
    ...
    var dt = function () {
            var e, t;
            null === (e = Fe.current) || void 0 === e || e.delayHidden(), null === (t = qe.current) || void 0 === t || t.delayHidden()
        },
        ht = function (n, r, o, c, l, f, v, d) {
            var h = e.useRef(),
                m = e.useState(null),
                g = i(m, 2),
                p = g[0],
            ...
            return s((function () {
                    if (p && p.times < 10) {
                        if (!n.current) return void w((function (e) {
                            return t({}, e)
                        }));
                        f();
                        var e = p.targetAlign,
                            ...
                            u = p.index,
                            a = p.offset,
                            s = n.current.clientHeight,
                            d = !1,
                            h = e,
                            m = null;
                        if (s) {
                            for (var g = e || i, R = 0, M = 0, E = 0, S = Math.min(r.length - 1, u), b = 0; b <= S; b += 1) {
                                var y = l(r[b]);
                                M = R;
                                var x = o.get(y);
                                R = E = M + (void 0 === x ? c : x)
                            }
                            for (var L = "top" === g ? a : s - a, H = S; H >= 0; H -= 1) {
                                var T = l(r[H]),
                                    z = o.get(T);
                                if (void 0 === z) {
                                    d = !0;
                            ...
                            switch (g) {
                                ...
                                case "bottom":
                                    ...
                                    break;
                                default:
                                    var D = n.current.scrollTop;
                                    M < D ? h = "top" : E > D + s && (h = "bottom")
                            }
                            null !== m && v(m), m !== p.lastTop && (d = !0)
                        }
                        d && w(t(t({}, p), {}, {
                            times: p.times + 1,
                            targetAlign: h,
                ...
                function (e) {
                    if (null != e) {
                        if (a.cancel(h.current), "number" == typeof e) v(e);
                        else if (e && "object" === u(e)) {
                            var t, n = e.align;
                            t = "index" in e ? e.index : r.findIndex((function (t) {
                                return l(t) === e.key
                            }));
                            var o = e.offset;
                            w({
    ...
    e.useImperativeHandle(l, (function () {
        return {
            ...
            scrollTo: function (e) {
                var t;
                (t = e) && "object" === u(t) && ("left" in t || "top" in t) ? (void 0 !== e.left && ye(at(e.left)), ht(e.top)) : ht(e)
            }
        }
    })), s((function () {
        if (Z) {
            var e = de.slice(_e, Ae + 1);
            Z(e, de)
        }
    }), [_e, Ae, de]);
    var mt = function (t, n, r, o) {
            ...
            return function (e) {
                ...
                if (void 0 === u || void 0 === a)
                    for (var s = t.length, f = l.length; f < s; f += 1) {
                        var v, d = t[f],
                            h = n(d);
                        c.set(h, f);
                        var m = null !== (v = r.get(h)) && void 0 !== v ? v : o;
                        if (l[f] = (l[f - 1] || 0) + m, h === e && (u = f), h === i && (a = f), void 0 !== u && void 0 !== a) break
                    }
                return {
                    top: l[u - 1] || 0,
                    bottom: l[a]
        ...
        }(de, _e, Ae, K, be, oe, _, ke),
        wt = null;
    Y && (wt = t(n({}, I ? "height" : "maxHeight", Y), D), ce && (wt.overflowY = "hidden", K && (wt.overflowX = "hidden"), He && (wt.pointerEvents = "none")));
    var Rt = {};
    return fe && (Rt.dir = "rtl"), e.createElement("div", r({
        ref: ge,
        style: t(t({}, P), {}, {
            position: "relative"
        }),
        className: ve
    }, Rt, ee), e.createElement(h, {
        onResize: function (e) {
            We({
                width: e.offsetWidth,
        ...
        className: "".concat(k, "-holder"),
        style: wt,
        ref: he,
        onScroll: function (e) {
            var t = e.currentTarget.scrollTop;
            t !== Re && Ne(t), null == F || F(e), it()
        },
        onMouseEnter: dt
    }, e.createElement(m, {
        prefixCls: k,
        ...
        onStopMove: De,
        spinSize: Ge,
        containerSize: Ve.height,
        style: null == Q ? void 0 : Q.verticalScrollBar,
        thumbStyle: null == Q ? void 0 : Q.verticalScrollBarThumb,
        showScrollBar: $
    }), se && K > Ve.width && e.createElement(L, {
        ref: qe,
        prefixCls: k,
        scrollOffset: be,
        scrollRange: K,
        ...
        onStopMove: De,
        spinSize: Ze,
        containerSize: Ve.width,
        horizontal: !0,
        style: null == Q ? void 0 : Q.horizontalScrollBar,
        thumbStyle: null == Q ? void 0 : Q.horizontalScrollBarThumb,
        showScrollBar: $
    }))
}
var N = e.forwardRef(k);
N.displayName = "List";
export {
    N as L
};
